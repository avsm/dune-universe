PACKAGES=opam-devel dune-release utop bun odoc merlin ocp-indent craml mirage mirage-types-lwt async core_extended patdiff atdgen xenstore ppx_driver xen-gnt xen-evtchn xenctrl shared-memory-ring
