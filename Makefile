...
PINS=ocp-indent odoc tyxml ocamlformat merlin ppx_tools_versioned mirage-flow mirage-flow-lwt mirage-flow-unix mirage-flow-rawlink xenstore ipaddr lambda-term shared-memory-ring
